            ...
            <div className="container relative" ref={parallaxRef}>
                <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
                    <h1 className="h1 mb-6">
                        Accelerating the adoption of&nbsp;AI&nbsp;for research in{` `}
                        <span className="inline-block relative">
                             Finance<img src={curve} className="absolute top-full left-0 w-full xl:-mt-2" width={624} height={28} alt="" />
                        </span>
                    </h1>
                    ...
                    <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                        ...
                        <Button href="#modelsense" className="bg-n-6 hover:bg-n-5 transition-colors">
                            Try ModelSense Premium
                            <span className="ml-2 px-2 py-1 bg-[#1B1B2E] rounded-full text-[0.7rem] font-semibold">$799.9/mo</span>
                        </Button>
                    </div>
                </div>
                        ...
                        <div className="relative bg-n-8 rounded-[1rem]">
                            ...
                            <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                                ...
                                <div className="flex items-center h-[3.5rem] px-6 bg-n-8/80 rounded-[1.7rem] absolute left-4 right-4 bottom-5 md:left-1/2 md:right-auto md:bottom-8 md:w-[31rem] md:-translate-x-1/2 text-base">
                                    ...
                                    How is the 5th version black scholes model validated
                                </div>
                                ...
                                <ScrollParallax isAbsolutelyPositioned>
                                    <Notification className="hidden absolute -right-[5.5rem] bottom-[11rem] w-[18rem] xl:flex" title="Collaborative analysis" />
                                </ScrollParallax>
                            </div>
                        </div>
                ...
                <div className="hidden relative z-10 mt-20 lg:block">
                    <h5 className="tagline mb-6 text-center text-white/50">Helping quants and financial analysts with research at</h5>
                    <ul className="flex">
