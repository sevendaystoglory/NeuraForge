    ...
    return (
        <Section id="how-to-use">
            <div className="container">
                <Heading title="AI Agent Financial Researchers." text="Neuraforge offers a financial AI agent that will help you sift through hunderds of financial documents answers." />
